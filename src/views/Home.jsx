...
const HomeView = () => {
  ...
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-center gap-4 overflow-hidden bg-gray-50 p-6 pt-24 md:pt-16">
      {/* Figuras decorativas */}
      ...
      <section className="z-10 flex w-full max-w-6xl flex-col items-center gap-12 md:flex-row">
        ...
        <div className="flex-1 text-center md:text-left">
          <h1 className="animate-fadeIn mb-4 text-3xl font-bold text-gray-900 md:text-5xl">
            {t("ALEX")}{" "}
            <span className="text-orange-500">{t("COVARRUBIAS-V")}</span>
          </h1>
          ...
          <div className="animate-fadeIn mb-6 flex flex-col gap-2 text-gray-600 delay-200">
            ...
            <div className="flex items-center justify-center gap-2 md:justify-start">
              <FaEnvelope className="flex min-h-4 min-w-4 items-start text-gray-700" />
              <a
      ...
      <div className="relative mt-28 flex items-start justify-start">
        <div className="h-1/1.5 w-1/1.5 ml-10 overflow-hidden rounded-2xl shadow-2xl">
          <img
            src={profileImage1}
            alt="Alex microfono"
            className="animate-fadeIn h-full w-full rounded-2xl object-cover delay-300"
        ...
        <div className="ml-10 flex flex-col justify-start">
          <h1 className="text-gray-1000 text-4xl font-bold">
            Expert in the Mexican auto industry, labor relations, and
            sustainable mobility, with leadership in research.
          </h1>
          <p className="mt-14 mr-20 ml-52 text-gray-600">
            I specialize in industrial and labor relations system changes, just
            transition, and socio-technical transformations, with a focus on
            transport electrification and energy transition.
          </p>
          <p className="mt-4 mr-20 ml-52 text-gray-600">
            I work on developing strategies for sustainable mobility and lead
            research initiatives to support industrial adaptation and workforce
            evolution.
          </p>
          <div className="animate-fadeIn mt-[-128px] flex flex-col justify-start gap-4 delay-400 md:flex-row md:justify-start">
            <button
              onClick={handleCVDownload}
      ...
      <section className="mt-10 bg-white py-16">
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
            {/* Logo 1 */}
            <div className="flex h-32 transform items-center justify-center rounded-lg border border-gray-200 p-6 transition-all hover:scale-105 hover:shadow-lg">
