...
export const Brief = () => {
  return (
    <div className="relative w-full z-10 flex flex-col items-center justify-center gap-4">
      <h1 className="text-center uppercase font-bold text-orange-500 text-3xl tracking-widest">Brief</h1>
