...
const resources = {
  en: {
    translation: {
      ...
      degree: "Degree: Doctor in Industrial and Labor Relations. Cornell University",
  ...
  es: {
    translation: {
      hello: "HOLA, SOY",
      name: "ALEX COVARRUBIAS VALDENEBRO",
      degree: "Grado: Doctor en Relaciones Industriales y Laborales. Universidad de Cornell",
